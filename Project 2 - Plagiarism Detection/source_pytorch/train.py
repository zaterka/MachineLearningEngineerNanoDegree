...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input_features', type=int, default=4, metavar='IF', 
                        help='number of initial input features (default:  4)')
    
    parser.add_argument('--hidden_dim', type=int, default=20, metavar='HL',
                        help='number of hidden layers in the network (default: 20)')
